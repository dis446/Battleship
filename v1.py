...
player_Board = [['O','O','O','O','O'],['O','O','O','O','O'],['O','O','O','O','O'],['O','O','O','O','O'],['O','O','O','O','O']]
bot_Board = [['O','O','O','O','O'],['O','O','O','O','O'],['O','O','O','O','O'],['O','O','O','O','O'],['O','O','O','O','O']]
...
def bot_locations():#Gets bot's ships' locations#
   ...
   if bot_ship_1["row"]==bot_ship_2["row"] and bot_ship_1["col"]==bot_ship_2["col"]:
       bot_locations()
   if bot_ship_1["row"]==bot_ship_3["row"] and bot_ship_1["col"]==bot_ship_3["col"]:
       bot_locations()
   if bot_ship_2["row"]==bot_ship_3["row"] and bot_ship_2["col"]==bot_ship_3["col"]:
       bot_locations()
...
def player_auto():#automatically gives player's ships' locations#
   ...
   if player_ship_1["row"]==player_ship_2["row"] and player_ship_1["col"]==player_ship_2["col"]:
       player_auto()
   if player_ship_1["row"]==player_ship_3["row"] and player_ship_1["col"]==player_ship_3["col"]:
       player_auto()
   if player_ship_2["row"]==player_ship_3["row"] and player_ship_2["col"]==player_ship_3["col"]:
       player_auto()
...
def player_manual():
   ...
   player_ship_1={"row":int(input("Choose a row for your first ship(1-5)")),"col":int(input("Choose a coloum for your first ship: "))}
   if player_ship_1["row"] not in range(1,6):
       print("Invalid input. Please input location again: ")
       player_manual()

   player_ship_2={"row":int(input("Choose a row for your second ship(1-5)")),"col":int(input("Choose a coloum for your second ship: "))}
   ...
   player_ship_3={"row":int(input("Choose a row for your third ship(1-5)")),"col":int(input("Choose a coloum for your third ship: "))}
...
def player_fire():
   ...
   global fire_col
   global fire_row
   fire_row=int(input("\nChoose a row to fire upon(1-5): "))
   check_int(fire_row)

   fire_col=int(input("Choose a column to fire upon(1-5): "))

   check_int(fire_col)

   #Checks if player has already fired there#
   for i in range(0,len(player_fired_rows)):
       if (player_fired_rows[i]==fire_row) and (player_fired_cols[i]==fire_col):
...
def battleship():
   ...
   """
   print("\n\nThese are the bot's ships' locations: ")
   print(bot_ship_1,bot_ship_2,bot_ship_3)
   """
   ...
   while winner == "":
       ...
       """
       print("These are where the player has already fired: ")
       print(player_fired_rows,player_fired_cols)
       """
       ...
       if fire_row==player_ship_1["row"] and fire_col==player_ship_1["col"]:
